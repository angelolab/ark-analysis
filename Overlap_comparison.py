...
# Cell 452, for example, can have its regionprops data output by accessing the 551st index
...
plt.imshow(x)
plt.colorbar()
plt.title("split cells, merged cells, bad cells")

plt.figure()
plt.imshow(contour_data)
