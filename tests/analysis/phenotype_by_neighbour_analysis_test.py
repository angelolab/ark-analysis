...
def generate_test_celldf():
	...
	celldf = pd.DataFrame({
		...
		'cell_cluster': ['Cancer','Immune','Immune','Immune','Cancer'],
		'label': range(5)
		})
	return(celldf)
...
def test_calculate_median_distance_to_cell_type():
	...
	cancer_dist = phenotype_by_neighbour_analysis.calculate_median_distance_to_cell_type(celldf, distdf, cell_cluster = 'Cancer', N = 2)
...
def test_calculate_median_distance_to_all_cell_types():
	...
	cancer_dist = phenotype_by_neighbour_analysis.calculate_median_distance_to_all_cell_types(celldf, distdf, N = 2)
