...
>>>>>>> 5ee9a5d (Single mantis directory (#1061))
    md = mantis_data
...
<<<<<<< HEAD
            mask_path = os.path.join(
                output_path, "population{}.tiff".format(md.mask_suffix)
            )
            original_mask_path: str = os.path.join(
                md.mask_output_dir, "%s_mask.tiff" % fov
            )
=======
