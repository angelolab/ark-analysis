...
def make_paths_visible(chooser, dir_to_assign: str = None, file_to_assign: str = None) -> None:
    """Assign path and file returned by FileChooser globally to specified vars

    Args:
        chooser (FileChooser):
            The FileChooser instance
        dir_to_assign (str):
            The directory variable set by the user to store in path_vars
        file_to_assign (str):
            The file variable set by the user to store in path_vars
    """
    if dir_to_assign:
...
def create_file_chooser(home_dir: str, dir_to_assign: str = None, file_to_assign: str = None):
    ...
    Args:
        home_dir (str):
            The root directory to show the user
        dir_to_assign (str):
            The directory variable set by the user to store in path_vars
        file_to_assign (str):
            The file variable set by the user to store in path_vars
    """
    if dir_to_assign:
        path_vars[dir_to_assign] = None
    if file_to_assign:
        path_vars[file_to_assign] = None

    fc = FileChooser(home_dir)
    fc.register_callback(lambda chooser: make_paths_visible(chooser, dir_to_assign, file_to_assign))
    display(fc)
