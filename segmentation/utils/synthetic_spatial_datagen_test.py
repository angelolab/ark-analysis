...
def test_generate_two_cell_ring_coords():
    # this function tests the functionality of generating rings within a predefined
    # interval of desired radii lengths, which will fill in a doughnut-like ring
    pass
