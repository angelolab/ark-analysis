...
def create_neighborhood_matrix(all_data, dist_matrices_dict, included_fovs=None, distlim=50, fov_col="SampleID",
                               cluster_id_col="FlowSOM_ID", cell_label_col="cellLabelInImage",
                               cluster_name_col="cell_type"):
    """Calculates the number of neighbor phenotypes for each cell.

        Args:
            all_data (pandas df): data for the all fovs in the form of a pandas DF, including the columns of SampleID (fovs),
