...
import xarray as xr
import numpy as np
from segmentation.utils import data_utils, plot_utils
...
save_dir = base_dir + "caliban_v3/"

if not os.path.isdir(save_dir):
    os.makedirs(save_dir)

# load segmentation generated by current version of deepcell, as well as points directory containing channels
segmentation_xr = xr.open_dataarray(base_dir + "/caliban_v2/segmentation_output_pixel_smooth_1/deepcell_output_pixel_processed_segmentation_labels.nc")
...
channel_xr = xr.open_dataarray(base_dir + "/Na_denoised_network/Na_no_background/deepcell_input.nc")


# selena specific code
channel_xr1 = data_utils.load_tifs_from_points_dir(base_dir + "no_noise", tif_folder="TIFs", tifs=["H3.tif"])
channel_xr2 = data_utils.load_tifs_from_points_dir(base_dir + "Na_no_noise", tif_folder="", tifs=["Na_rescaled.tif"])
channel_xr = data_utils.combine_xarrays((channel_xr, channel_xr1), -1)
...
channel_xr = data_utils.reorder_xarray_channels(channel_order=channel_order, channel_xr=channel_xr)
...
for channel in overlay_channels:
    ...
    plot_utils.plot_overlay(mask, plotting_tif=chan_marker,
